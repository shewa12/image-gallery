...
<v-row>
    <v-col cols="12" md="6" offset-md="3">
        <v-card  align="center" justify="center">
            ...
            <div >               
                <croppa  v-model="croppa" :class="filter">
                    <img crossorigin="anonymuos" :class="filter"  :src="$route.params.file_url"
                        slot="initial">
                </croppa>           
            </div>
                    ...
                    <v-row>
                        <v-col cols="12">
                            ...
                            <v-col>
                                ...
                                <span class="buttons">
                                    <v-btn outlined="" class="rotate activeRotate" @click="croppa.rotate('0deg')">0 deg</v-btn>
                                    <v-btn outlined="" class="rotate " @click="croppa.rotate('30deg')" id="rotate30deg">30 deg</v-btn>
                                    <v-btn outlined="" class="rotate " @click="croppa.rotate('60deg')" id="rotate60deg">60 deg</v-btn>
                                    <v-btn outlined="" class="rotate " @click="croppa.rotate(1)" id="rotate90deg">90 deg</v-btn>
                                    <v-btn outlined="" class="rotate " @click="croppa.rotate(2)" id="rotate180deg">180 deg</v-btn>                                    
                                </span>
                            </v-col>
                            <v-col>
        ...
        <!--tab end-->
            ...
            <v-card-actions align="right">
                ...
                <v-btn  color="primary" type="button" @click="save">Save</v-btn>
            </v-card-actions>                
...
/*
        ...
        fetch(apiurl,{
            method:'post',
            body: form
        }).then(res=> res.json()).then(res=>this.image=res).catch(err=>alert(err));
*/
    },
    methods:{
